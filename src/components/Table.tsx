...
const DefaultEmptyState = (props: { columns: TableColumn<any>[]; title?: string; detail?: string }) => {
  return (
    <tr>
      <td colspan={props.columns.length} class="h-[200px]">
...
const Table = <T,>(props: TableProps<T>) => {
  return (
    <div class="flex flex-col gap-4">
      ...
      <div class="relative w-full max-h-[70vh] rounded-lg border border-primary/20 shadow-[0_0_25px_rgba(226,254,116,0.1)] overflow-auto">
